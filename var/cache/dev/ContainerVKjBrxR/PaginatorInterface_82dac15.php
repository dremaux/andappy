...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer8f1ae && ($this->initializer8f1ae->__invoke($valueHolder350eb, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer8f1ae) || 1) && $this->valueHolder350eb = $valueHolder350eb;

        if ($this->valueHolder350eb === $returnValue = $this->valueHolder350eb->paginate($target, $page, $limit, $options)) {
            return $this;
        }

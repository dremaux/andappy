...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer37d16 && ($this->initializer37d16->__invoke($valueHolder431e4, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer37d16) || 1) && $this->valueHolder431e4 = $valueHolder431e4;

        if ($this->valueHolder431e4 === $returnValue = $this->valueHolder431e4->paginate($target, $page, $limit, $options)) {
            return $this;
        }

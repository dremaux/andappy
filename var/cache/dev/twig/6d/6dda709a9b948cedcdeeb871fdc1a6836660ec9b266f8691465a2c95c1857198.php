...
class __TwigTemplate_875cd7e4b2085104130a5fc9064ebb6443e3ab3fb7cecc1827f1a330a5c0a247 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"container mt-4\">
        ...
        ";
        // line 27
        echo twig_nl2br(twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["property"]) || array_key_exists("property", $context) ? $context["property"] : (function () { throw new RuntimeError('Variable "property" does not exist.', 27, $this->source); })()), "description", [], "any", false, false, false, 27), "html", null, true));
        echo "
        </P>

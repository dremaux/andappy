...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer9f1ce && ($this->initializer9f1ce->__invoke($valueHolder9407d, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer9f1ce) || 1) && $this->valueHolder9407d = $valueHolder9407d;

        if ($this->valueHolder9407d === $returnValue = $this->valueHolder9407d->paginate($target, $page, $limit, $options)) {
            return $this;
        }
